<template>
  <div class="app">
    <div class="headers">
      <van-nav-bar title="服务详情" left-arrow @click-left="onClickLeft" />
    </div>
    <div class="content">
      <div class="author">
        ...
        <span>{{info.userName}}</span>
            ...
            <img v-if="index <= starnum" src="../assets/star.png" class="star" v-show="starnum !=0"/>
        </span>
      </div>
      <div class="wrapper">
        <div class="name">
        ...
        <p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">工作地点: {{ info.workaddress }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'||projecttype=='宝贝转卖'||projecttype=='项目承包'||projecttype=='咨询服务'||projecttype=='培训服务'">发布时间: {{ info.updatetime }}</p>
      ...
      <div class="wrapper">
        <div class="name">
          ...
          <span>详细信息</span>
				...
				<p v-show="projecttype=='宝贝转卖'">交易方式: {{ info.tradeType==0?"直接交易":"平台担保" }}</p>
				...
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">职能: {{ info.functions }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">产品方向: {{ info.productDir }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">技能关键字: {{ info.skill }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">熟悉的EDA工具: {{ info.edaTool }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">经历技能介绍: {{ info.experience }}</p>
				<p v-show="projecttype=='兼职服务'">工作时间: {{ info.worktime }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">工作模式: {{ info.workmode }}</p>
				<p v-show="projecttype=='兼职服务'">工作地点: {{ info.workaddress }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">期望待遇: {{ info.pay }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">最早开工时间: {{ info.startTime }}</p>
				<p v-show="projecttype=='宝贝转卖'">可预约人数: {{ info.maxnum||0 }}</p>
				<p v-show="projecttype=='兼职服务'||projecttype=='全职服务'">有效期: {{ info.validity }}个月</p>
				<!-- <p v-show="projecttype=='兼职服务'">其他条件: {{ info.other||'无' }}</p> -->
      </div>
      <div class="wrapper">
        <div class="name">
          <span class="pingjia">
